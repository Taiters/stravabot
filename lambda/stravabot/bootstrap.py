...
from stravabot.config import JWT_SECRET_KEY, KV_STORE_TABLE, STRAVA_EVENT_QUEUE_URL
...
def bootstrap() -> Api:
    ...
    api_request_forwarder = ApiRequestForwarder(sqs.Queue(STRAVA_EVENT_QUEUE_URL))
